...
--
-- Host: localhost
-- Generation Time: Apr 21, 2015 at 11:32 PM
...
CREATE TABLE IF NOT EXISTS `currentstatus` (
  ...
  `techFName` varchar(20) NOT NULL,
  `techLName` varchar(20) NOT NULL,
  `currentLocation` varchar(30) NOT NULL,
  `typeOfWork` varchar(20) NOT NULL,
  `appointmentDate` date NOT NULL,
  `appointmentTime` time NOT NULL,
  `nextLocation` varchar(30) NOT NULL
...
INSERT INTO `customer` (`userID`, `cfName`, `clName`, `cstreetAddy`, `cCity`, `cZip`, `cState`, `cPhone`, `cEmail`) VALUES
(1, 'Fred', 'Durst', '123 Dbag street', 'New York City', 12345, 'New York', 1231231234, ''),
(2, 'bob', 'soul', '1234 Me Dr', 'Me', 12345, 'AZ', 1234567890, 'bob@me');
...
(6, 'Title', 'Notesssssss', 'Note Man'),
(7, 'Title 2', 'Notes. More Notesss.', 'Bob');
...
--
ALTER TABLE `customer`
MODIFY `userID` int(16) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `statusnotes`
--
ALTER TABLE `statusnotes`
